...
export default function AdminAnalytics() {
      ...
      return (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                  ...
                  <p className="text-sm text-slate-400">Avg resolution: {analytics?.avgResolutionHours || 0} hours</p>

                  <div className="grid lg:grid-cols-2 gap-6">
                        <div className="rounded-2xl bg-white/5 border border-white/10 p-4 h-72">
                              <h3 className="text-sm font-bold text-white mb-3">Complaints (30 days)</h3>
